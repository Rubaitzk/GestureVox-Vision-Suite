...
number_of_classes = 25# Reduced for testing, change back to 20 when ready
dataset_size = 100

cap = cv2.VideoCapture(0)

values_to_loop = [number_of_classes - 2, number_of_classes - 1] # [23, 24]

for j in values_to_loop:
